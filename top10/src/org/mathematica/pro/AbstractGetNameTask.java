...
public abstract class AbstractGetNameTask extends AsyncTask<Void, Void, Void> {
	...
	protected NewMainMenu mActivity;

	protected String mScope;
	protected String mEmail;
	protected int mRequestCode;

	AbstractGetNameTask(NewMainMenu activity, String email, String scope,
			int requestCode) {
	 ...
	 *             in response
	 */
	private void getUserInfo(String jsonResponse) throws JSONException {
		JSONObject profile = new JSONObject(jsonResponse);
		mActivity.show(profile.getString(NAME_KEY),
